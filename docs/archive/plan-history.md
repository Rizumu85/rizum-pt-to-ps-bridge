...
Archived `plan.md` checklist as of the removal of the UXP Photoshop plugin.
Completed steps from the M1/M2 milestones, the UXP panel, and the manual
return export are recorded here; `plan.md` keeps current directions.
